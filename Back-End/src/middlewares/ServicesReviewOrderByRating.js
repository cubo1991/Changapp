...
module.exports = router.get('/order', async (req, res, next) => {

  try{

    let {dir, filter} = req.query;

  /* http://localhost:3000/review/order?dir=ASC (ASC para orden ascendente, DESC para descendente) =>
    ...
    }else if (filter && (dir === "ASC" || dir === "DESC")){   // http://localhost:3000/review/order?filter=Limpieza de Hospitales&dir=ASC
